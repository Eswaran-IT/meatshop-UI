...
// Lazy load LoyaltyRewards page
const LoyaltyRewardsLazy = React.lazy(() => import('./pages/admin/LoyaltyRewards'));
  ...
  return (
    <Routes>
      {isAdmin ? (
        ...
        <>
          <Route path="/auth" element={<LoginForm onSuccess={() => window.location.replace('/')} />} />
