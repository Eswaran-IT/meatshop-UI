      ...
      <Card>
        <CardHeader className="text-center">
          <CardTitle className="text-2xl">
            {step === 'login' ? 'Welcome to Butcher Blend' : 'Create Account'}
          </CardTitle>
          <CardDescription>
            {step === 'login' ? 'Enter your credentials to continue' : 'Sign up for a new account'}
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          {/* Demo Credentials Info - Only for testing */}
          {step === 'login' && (
