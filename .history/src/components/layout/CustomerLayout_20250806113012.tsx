...
const CustomerLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Animated Free Delivery Banner - always visible, above navbar */}
      <div
        className="w-full overflow-x-hidden bg-white py-2 fixed top-0 left-0 z-50 shadow flex items-center"
        style={{margin:0, padding:0, minHeight:'44px'}}
      >
        {/* Left: Location & Phone (sticky, 40%) */}
        <div
          className="flex items-center gap-4 pl-4 pr-2 text-sm text-gray-700 font-medium"
          style={{width:'40%', minWidth: '180px', flexShrink:0}}
        >
        ...
        {/* Right: Animated Free Delivery (60%) */}
        <div
          className="relative flex-1 h-full overflow-x-hidden"
          style={{width:'60%'}}
        >
          <div
            className="whitespace-nowrap text-lg font-semibold text-red-600 flex items-center gap-2 absolute left-0 top-1/2 -translate-y-1/2"
            style={{
