...
const CustomerLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <nav className="w-full bg-white border-b border-gray-200 h-8 flex items-center justify-between px-4 text-xs font-medium" style={{minHeight:'32px'}}>
        <div className="flex items-center gap-4 w-1/2 min-w-[120px] text-gray-600">
        ...
        <div className="relative w-1/2 h-full overflow-x-hidden flex items-center justify-end">
          <div
            className="whitespace-nowrap text-xs md:text-sm font-semibold text-red-600 flex items-center gap-2 absolute left-0 top-1/2 -translate-y-1/2"
            style={{
