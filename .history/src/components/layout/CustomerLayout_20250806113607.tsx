...
const CustomerLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Top Info Bar: static, slim, neat, no overlap */}
      <nav className="w-full bg-white border-b border-gray-200 flex items-center justify-between px-4 text-xs font-medium" style={{height:'28px', minHeight:'28px'}}>
        <div className="flex items-center gap-4 w-1/2 min-w-[120px] text-gray-600 truncate">
        ...
        <div className="relative w-1/2 h-full overflow-x-hidden flex items-center justify-end">
          <div
            className="whitespace-nowrap text-xs md:text-sm font-semibold text-red-600 flex items-center gap-2"
            style={{
