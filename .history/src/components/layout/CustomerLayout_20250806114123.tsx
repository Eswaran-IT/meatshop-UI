...
const CustomerLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Sticky Top Info Bar: slim, gap below, animated free delivery */}
      <nav className="w-full bg-white border-b border-gray-200 flex items-center justify-between px-4 text-[11px] font-medium sticky top-0 z-40" style={{height:'22px', minHeight:'22px'}}>
        <div className="flex items-center gap-3 w-1/2 min-w-[120px] text-gray-600 truncate">
          <span className="flex items-center gap-1"><span role="img" aria-label="location">📍</span>Mumbai, India</span>
          <span className="flex items-center gap-1"><span role="img" aria-label="phone">📞</span>+91 98765 43210</span>
        </div>
        <div className="relative w-1/2 h-full overflow-x-hidden flex items-center justify-end">
          <div
            className="whitespace-nowrap text-xs font-semibold text-red-600 flex items-center gap-2"
            style={{
      ...
      {/* Main Navbar */}
      <header className="bg-white border-b shadow-sm sticky top-[22px] z-30">
