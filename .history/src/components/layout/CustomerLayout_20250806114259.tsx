...
const CustomerLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Slim Top Navbar: Location/Phone left, Animated Free Delivery right */}
      {/* Sticky Top Info Bar: Lucide icons, extra small, compact, animated free delivery */}
      <nav className="w-full bg-white border-b border-gray-200 flex items-center justify-between px-4 text-[10px] font-medium sticky top-0 z-40" style={{height:'18px', minHeight:'18px'}}>
        <div className="flex items-center gap-2 w-1/2 min-w-[100px] text-gray-500 truncate">
          <span className="flex items-center gap-0.5"><MapPin className="h-3 w-3" /><span className="ml-0.5">Mumbai, India</span></span>
          <span className="flex items-center gap-0.5"><Phone className="h-3 w-3" /><span className="ml-0.5">+91 98765 43210</span></span>
        </div>
        <div className="relative w-1/2 h-full overflow-x-hidden flex items-center justify-end">
          <div
            className="whitespace-nowrap text-[10px] font-semibold text-red-600 flex items-center gap-1"
            style={{
      ...
      {/* Main Navbar */}
      <header className="bg-white border-b shadow-sm sticky top-[18px] z-30">
            ...
            <div className="flex items-center space-x-4">
              ...
              {user ? (
                <div className="flex items-center gap-2">
                  ...
                  <Button onClick={() => { clearCart(); logout(); }} variant="ghost" size="icon" title="Logout" className="hover:bg-red-100">
