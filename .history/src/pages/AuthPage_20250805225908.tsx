  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md px-4">
        <AuthForm mode={isRegister ? 'register' : 'login'} onSuccess={() => navigate('/')} />
      </div>
    </div>
  );
};
              ...
              <Card>
                <CardContent className="pt-6 pb-8 space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        disabled={registerLoading || isOTPVerified}
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button 
                        ...
                        disabled={registerLoading || isOTPVerified || registerMobile.length !== 10 || !registerName.trim() || isRequestingOTP}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      {isOTPVerified ? (
                        ...
                        <Button 
                          ...
                          disabled={registerLoading || registerOTP.length !== 4}
                          className="whitespace-nowrap"
                        >
                          Verify OTP
                        </Button>
                    ...
                    {isOTPVerified && (
                      <p className="text-xs text-green-500 flex items-center mt-1">
                        <CheckCircle className="h-3 w-3 mr-1" /> Mobile number verified successfully
                      </p>
                    )}
                  </div>
                  ...
                  <Button 
                    ...
                    disabled={registerLoading || !isOTPVerified || !registerPassword || registerPassword !== registerConfirmPassword}
                  >
                    {registerLoading ? (
                      <>
                        <Loader2 className="mr-2 h-4 w-4 animate-spin" />
