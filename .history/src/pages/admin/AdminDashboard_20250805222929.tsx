  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        ...
        <Card className="bg-amber-50 border-amber-200 p-4 flex items-start gap-3 mt-4">
          <div className="bg-amber-100 p-2 rounded-full">
            <AlertTriangle className="h-5 w-5 text-amber-600" />
          </div>
          <div>
            <h3 className="font-medium text-amber-800">Admin Test Account</h3>
            <p className="text-sm text-amber-700 mt-1">
              You are currently logged in with admin test credentials. Admin users have access to the full admin dashboard and management features.
            </p>
          </div>
        </Card>
      </div>
