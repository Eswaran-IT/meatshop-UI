    ...
    <div className="max-w-6xl mx-auto py-8">
      <Card>
        ...
        <CardContent>
          ...
          {/* Filtering UI (search and category only) */}
          <div className="mb-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Input placeholder="Search by Name or Number" className="w-full" value={search} onChange={e => setSearch(e.target.value)} />
            <Input placeholder="Category (e.g. Chicken)" className="w-full" value={category} onChange={e => setCategory(e.target.value)} />
