    ...
    <div className="max-w-6xl mx-auto py-8">
      <Card>
        ...
        <CardContent>
          ...
          {/* Orders Table with filter fields in header */}
          <div className="overflow-x-auto mb-8">
            <table className="min-w-full text-sm">
              <thead>
                <tr className="bg-gray-100">
                  <th className="p-2">Order ID</th>
                  <th className="p-2">Customer Name<br/>
                    <Input className="w-32 mt-1" placeholder="Name" value={name} onChange={e => setName(e.target.value)} />
                  </th>
                  <th className="p-2">Mobile<br/>
                    <Input className="w-32 mt-1" placeholder="Number" value={number} onChange={e => setNumber(e.target.value)} />
                  </th>
                  <th className="p-2">Items<br/>
                    <select className="w-32 mt-1 border rounded" value={category} onChange={e => setCategory(e.target.value)}>
                  ...
                  <th className="p-2">Total (₹)<br/>
                    <div className="flex gap-1 mt-1">
                      <Input className="w-16" type="number" min="0" placeholder=">= Min" value={amountMin} onChange={e => setAmountMin(e.target.value)} />
                      <Input className="w-16" type="number" min="0" placeholder="<= Max" value={amountMax} onChange={e => setAmountMax(e.target.value)} />
                    </div>
                  </th>
                  <th className="p-2">Status</th>
                  <th className="p-2">Order Date<br/>
                    <Input className="w-24 mt-1" type="number" min="1" placeholder="Past N days" value={days} onChange={e => setDays(e.target.value)} />
                  </th>
                </tr>
              </thead>
              <tbody>
