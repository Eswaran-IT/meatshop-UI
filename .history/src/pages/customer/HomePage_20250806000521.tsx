...
const HomePage: React.FC = () => {
  ...
  return (
    <div>
      ...
      <section id="special-offers" className="py-12 bg-yellow-50">
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            <Card className="flex-1 bg-white border border-yellow-300">
              <CardContent className="p-6">
                <h3 className="font-bold text-xl mb-2 text-yellow-700">Flat 10% Off on All Chicken Products</h3>
                <p className="text-gray-600 mb-2">Use code <span className="font-mono bg-yellow-100 px-2 py-1 rounded">CHICKEN10</span> at checkout.</p>
                <Button className="bg-yellow-500 hover:bg-yellow-600 text-white mt-2" onClick={() => {
            ...
            <Card className="flex-1 bg-white border border-yellow-300">
              <CardContent className="p-6">
                <h3 className="font-bold text-xl mb-2 text-yellow-700">15% Off on Mutton for New Users</h3>
      ...
      <section id="meats-section" className="py-12 bg-gray-50">
        <div className="container px-4 md:px-6 mx-auto">
          ...
          {/* Categories Card View without Images */}
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {categories.map((category) => (
              <Card key={category.id} className="group cursor-pointer hover:shadow-lg transition-all overflow-hidden">
                <CardContent className="p-0">
                  <div className="relative h-24 flex flex-col justify-center items-center bg-gray-100 p-4">
