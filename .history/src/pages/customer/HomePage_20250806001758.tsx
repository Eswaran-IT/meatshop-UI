...
const HomePage: React.FC = () => {
  ...
  // If no category filter, show 1 product per category
  if (activeCategory === null) {
    const grouped: { [cat: string]: typeof featuredProducts } = {};
    filteredProducts.forEach(p => {
      if (!grouped[p.category]) grouped[p.category] = [];
      if (grouped[p.category].length < 1) grouped[p.category].push(p);
    });
        ...
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <Tabs defaultValue="coupons" className="w-full">
            <TabsList className="flex w-full mb-8">
              <TabsTrigger value="coupons" className="flex-1 text-lg py-3 rounded-none data-[state=active]:bg-red-600 data-[state=active]:text-white data-[state=inactive]:bg-gray-100 data-[state=inactive]:text-red-700">Coupon Codes</TabsTrigger>
              <TabsTrigger value="combos" className="flex-1 text-lg py-3 rounded-none data-[state=active]:bg-red-600 data-[state=active]:text-white data-[state=inactive]:bg-gray-100 data-[state=inactive]:text-red-700">Combo Offers</TabsTrigger>
            </TabsList>
            <TabsContent value="coupons">
              <div className="flex flex-wrap gap-6 justify-start">
                {/* Chicken Coupon */}
                <Card className="flex-1 min-w-[260px] max-w-xs bg-white border border-gray-200 overflow-hidden shadow-lg">
                  <CardContent className="p-0">
                    ...
                    <div className="p-4">
                      ...
                      <Button className="bg-red-600 hover:bg-red-700 text-white mt-2 w-full" onClick={() => {
                ...
                <Card className="flex-1 min-w-[260px] max-w-xs bg-white border border-gray-200 overflow-hidden shadow-lg">
                  <CardContent className="p-0">
                    ...
                    <div className="p-4">
                      ...
                      <Button className="bg-red-600 hover:bg-red-700 text-white mt-2 w-full" onClick={() => {
                        // Add to cart logic for combo offer (example: add both chicken and mutton combo to cart)
                ...
                <Card className="flex-1 min-w-[260px] max-w-xs bg-white border border-gray-200 overflow-hidden shadow-lg">
                  <CardContent className="p-0">
                    ...
                    <div className="p-4">
                      ...
                      <Button className="bg-red-600 hover:bg-red-700 text-white mt-2 w-full" onClick={() => {
                        // Add to cart logic for combo offer (example: add both fish and beef combo to cart)
                        alert('Combo added to cart!');
                      }}>Add to Cart</Button>
                    </div>
                  </CardContent>
