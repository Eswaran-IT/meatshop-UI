...
const HomePage: React.FC = () => {
  ...
  return (
    <div>
      ...
      <section id="special-offers" className="py-0 bg-white">
        <div className="container px-0 md:px-0 mx-auto">
          ...
          <Tabs defaultValue="coupons" className="w-full">
            <TabsList className="flex w-full mb-0 bg-gray-100 rounded-lg p-0">
              <TabsTrigger value="coupons" className="flex-1 text-lg py-0 transition rounded-lg data-[state=active]:bg-red-600 data-[state=active]:text-white data-[state=inactive]:bg-gray-100 data-[state=inactive]:text-red-700">Coupon Codes</TabsTrigger>
              <TabsTrigger value="combos" className="flex-1 text-lg py-0 transition rounded-lg data-[state=active]:bg-red-600 data-[state=active]:text-white data-[state=inactive]:bg-gray-100 data-[state=inactive]:text-red-700">Combo Offers</TabsTrigger>
            </TabsList>
              ...
              <div className="flex flex-wrap gap-0 justify-start">
                ...
                <Card className="flex-1 min-w-[260px] max-w-xs bg-white border border-gray-200 overflow-hidden shadow-lg flex flex-col min-h-[410px]">
                  <CardContent className="p-0 flex flex-col h-full">
                    ...
                    />
                    <div className="flex flex-col flex-1 p-0 justify-between">
                      <div>
                        <h3 className="font-bold text-xl mb-2 text-red-700 min-h-[56px] flex items-center">Flat 10% Off on All Chicken Products</h3>
                        <p className="text-gray-600 mb-0 min-h-[40px] flex items-center">Use code <span className="font-mono bg-gray-100 px-0 py-0 rounded">CHICKEN10</span> at checkout.</p>
                      </div>
            ...
            {filteredProducts.length > 0 ? (
              filteredProducts.map((product) => (
                <Card key={product.id} className="overflow-hidden group flex-1 min-w-[260px] max-w-xs flex flex-col min-h-[410px]">
                  ...
                  <CardContent className="p-0 flex flex-col flex-1 justify-between h-full">
                    <div>
                    ...
                    <div className="space-y-0 mt-0">
                      ...
                      <div className="flex justify-between items-center border rounded-md p-0">
      ...
      {/* Footer */}
      <footer className="bg-gray-900 text-white pt-0 pb-0">
        <div className="container px-0 md:px-0 mx-auto">
          ...
          <div className="border-t border-gray-800 pt-0 mt-0">
            <div className="flex flex-col md:flex-row justify-between items-center gap-0">
              ...
              <div className="flex gap-0 text-sm text-gray-400">
