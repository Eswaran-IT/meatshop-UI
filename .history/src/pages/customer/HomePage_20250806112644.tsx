...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      {/* Animated Free Delivery Banner - white bg, red text, top right absolute, no extra text */}
      <div
        className="w-full overflow-x-hidden bg-white py-2 fixed top-0 right-0 z-50 shadow"
        style={{margin:0, padding:0}}
      >
        <div
          className="whitespace-nowrap text-lg font-semibold text-red-600 flex items-center gap-2"
          style={{
