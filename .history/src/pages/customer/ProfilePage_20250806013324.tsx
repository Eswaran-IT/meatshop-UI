  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col gap-0 p-0 m-0">
        ...
        <div className="w-full flex flex-col lg:flex-row gap-0 m-0 p-0">
          {/* Profile Card (left) */}
          <div className="w-full lg:w-1/2 flex flex-col justify-stretch m-0 p-0">
            <Card className="h-full w-full m-0 p-0 flex flex-col justify-stretch">
