    ...
    <>
      ...
      <div className="w-full flex flex-col gap-6 p-4 md:p-8">
        ...
        <div className="space-y-2 m-0 p-0">
          <h1 className="text-2xl md:text-3xl font-bold tracking-tight m-0 p-0">My Profile</h1>
          <p className="text-muted-foreground text-sm md:text-base m-0 p-0">
            Manage your account settings and preferences
          </p>
        </div>
        <div className="w-full flex flex-wrap gap-6 m-0 p-0">
          {/* Profile Card */}
          <div className="flex-1 min-w-[320px] max-w-full lg:max-w-[420px] flex flex-col justify-stretch">
            <Card className="h-full w-full p-4 rounded-xl shadow-sm bg-white flex flex-col justify-stretch">
              ...
              <CardContent className="flex-1 m-0 p-0">
                {editingProfile ? (
                  <form className="grid grid-cols-1 md:grid-cols-2 gap-4 m-0 p-0" onSubmit={e => { e.preventDefault(); handleProfileSave(); }}>
                    <div className="flex flex-col gap-1 m-0 p-0">
                    ...
                    <div className="flex gap-2 col-span-1 md:col-span-2 mt-2 m-0 p-0">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2 m-0 p-0">
                    <div><span className="font-medium">Name:</span> {profile.name}</div>
                    <div><span className="font-medium">Email:</span> {profile.email}</div>
                    <div><span className="font-medium">Mobile:</span> {profile.phone}</div>
                    <div><span className="font-medium">Date of Birth:</span> {profile.dateOfBirth}</div>
                    <div><span className="font-medium">Anniversary:</span> {profile.anniversary}</div>
                  </div>
                )}
              </CardContent>
            </Card>
          ...
          <div className="flex-1 min-w-[320px] max-w-full lg:max-w-[420px] flex flex-col justify-stretch">
            <Card className="h-full w-full p-4 rounded-xl shadow-sm bg-white flex flex-col justify-stretch">
              <CardHeader className="m-0 p-0">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 m-0 p-0">
              ...
              <CardContent className="flex-1 space-y-4 m-0 p-0">
