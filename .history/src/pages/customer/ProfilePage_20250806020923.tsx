        ...
        <div className="lg:col-span-2">
          ...
          <Card className="mt-8">
            ...
            <CardContent>
              <div>
                {addresses.map(addr => (
                  <div key={addr.id} className="p-4 mb-4 border rounded-lg">
                    <div className="flex items-center justify-between">
                      <div>
                      <div className="font-semibold mb-1">{addr.type}</div>
                ...
                {showAddressForm && (
                  <div ref={addressFormRef} className="p-4 border-2 border-gray-300 rounded-lg bg-gray-50 mb-4">
